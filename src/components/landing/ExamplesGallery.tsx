...
function SpriteCard({ sprite }: { sprite: FeaturedSprite }) {
  ...
  return (
    <div className="group relative bg-[#0a0a0f]/80 border border-white/10 rounded-xl overflow-hidden hover:border-[#00d4ff]/50 transition-all duration-300 hover:scale-[1.02]">
      {/* Image */}
      <div className="aspect-square relative bg-gradient-to-br from-white/5 to-white/0">
        ...
        <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex flex-col items-center justify-center gap-2 p-3">
          <Link
            href={generateUrl}
            className="w-full flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-[#00ff88] text-black text-xs font-bold hover:bg-[#00d4ff] transition-colors"
          >
    ...
    <section id="gallery" className="py-16 sm:py-24 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 relative z-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
          {loading ? (
            [...Array(8)].map((_, i) => (
              <div key={i} className="relative bg-[#0a0a0f]/80 border border-white/10 rounded-xl overflow-hidden">
