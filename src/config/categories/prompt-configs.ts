...
export const WEAPONS_PROMPT_CONFIG: Record<string, SubcategoryPromptConfig> = {
  SWORDS: {
    ...
    composition: "single sword shown flat or slight angle, full blade visible from tip to pommel, weapon displayed as game item",
    avoid: "multiple swords, broken blade, hand holding it, sword in stone, sheathed in scabbard, combat scene",
  },
  AXES: {
    objectType: "axe or hammer weapon",
    ...
    composition: "single weapon shown from side, full head and handle visible, displayed as collectible item",
    avoid: "multiple weapons, stuck in wood or stone, hand holding it, logging or smithing scene, broken handle",
  },
  POLEARMS: {
    ...
    composition: "single polearm shown vertically or diagonal, full length visible from tip to butt",
    avoid: "multiple spears, broken shaft, soldier holding it, battle scene, just the head without shaft",
  },
  BOWS: {
    ...
    composition: "single bow shown front or slight angle, full curve and string visible, no arrow nocked, at rest position",
    avoid: "multiple bows, archer holding it, arrow already nocked, quiver of arrows, drawing the bow",
  },
  STAFFS: {
    objectType: "magical staff or wand",
    ...
    composition: "single staff shown vertically, full length with magical top visible, floating or standing",
    avoid: "multiple staffs, wizard holding it, plain walking stick without magic, broken or cracked",
  },
  GUNS: {
    ...
    composition: "single gun shown from side profile, full weapon visible from barrel to grip",
    avoid: "multiple guns, hand holding it, bullets or ammo separate, holster, firing with muzzle flash",
  },
  THROWING: {
    ...
    composition: "single throwing weapon centered, shown flat displaying full shape and details",
    avoid: "multiple throwing weapons, hand throwing it, target or impact, in-flight motion blur",
  },
};
...
export const ARMOR_PROMPT_CONFIG: Record<string, SubcategoryPromptConfig> = {
  HELMETS: {
    objectType: "isolated helmet equipment item",
    visualDesc: "ISOLATED helmet as equipment item - protective headgear shown as STANDALONE OBJECT without any body parts, empty helmet like inventory loot",
    composition: "single empty helmet displayed as collectible item, NO HEAD INSIDE - helmet as game item pickup on invisible stand, front or 3/4 view",
    avoid: "head inside helmet, person wearing it, face visible, neck attached, mannequin head, body parts, multiple helmets",
  },
  CHEST_ARMOR: {
    objectType: "isolated chest armor equipment item",
    visualDesc: "ISOLATED chest armor as equipment item - breastplate, chainmail, leather chest piece shown as STANDALONE OBJECT without any body parts",
    composition: "single empty chest armor displayed as collectible item, NO TORSO INSIDE - armor as game item on invisible armor stand, front view",
    avoid: "body inside armor, person wearing it, arms attached, shoulders with arms, mannequin body, body parts, full figure",
  },
  SHIELDS: {
    objectType: "shield defensive equipment",
    visualDesc: "handheld defensive barrier - round, kite, tower, or buckler shape, may have emblem, boss, or magical runes",
    composition: "single shield shown front face, full shield visible including rim and handle area (from front)",
    avoid: "person holding it, multiple shields, broken or shattered shield, shield on someone's back",
  },
  GLOVES: {
    objectType: "isolated gloves equipment item",
    visualDesc: "ISOLATED gloves as equipment item - metal gauntlets, leather gloves, armored bracers, or magical hand wraps shown as STANDALONE OBJECTS without any body parts",
    composition: "gloves displayed as collectible items lying flat or arranged together like loot drops, NO HANDS OR ARMS INSIDE - empty gloves as game item pickup, inventory item presentation",
    avoid: "hands inside gloves, arms attached, fingers visible, worn on body, mannequin hands, human hands, body parts, hands wearing them, arms or wrists",
  },
  BOOTS: {
    objectType: "isolated boots equipment item",
    visualDesc: "ISOLATED boots as equipment item - armored boots, leather boots, greaves, or magical footwear shown as STANDALONE OBJECTS without any body parts",
    composition: "boots displayed as collectible items like loot drops, NO LEGS OR FEET INSIDE - empty boots as game item pickup, inventory item presentation, standing or lying arrangement",
    avoid: "legs inside boots, feet wearing them, worn on body, mannequin legs, human legs, body parts, legs attached, ankles or calves visible",
  },
  ACCESSORIES: {
    objectType: "armor accessory item",
    visualDesc: "wearable accessory like belt with pouches, flowing cape, magical ring, glowing amulet, or ornate bracelet",
    composition: "single accessory item centered, full item visible with details clear",
    avoid: "person wearing it, multiple different accessories, full outfit shown, too tiny to see details",
  },
};
